...
exports.name = '/ins/search'
exports.index = async (req, res, next) => {
    var search = req.query.search
    if (!search) return res.jsonp({ error: 'Thiếu dữ liệu' });
...
axios.request(options).then(function (response) {
  ...
  obj["name"] = r.users[0].user
  obj["name_1"] = r.users[1].user
  obj["name_2"] = r.users[2].user
  obj["name_3"] = r.users[3].user
  obj["name_4"] = r.users[4].user
  obj["name_5"] = r.users[5].user
  obj["name_6"] = r.users[6].user
  obj["name_7"] = r.users[7].user
  obj["name_8"] = r.users[8].user
  obj["name_9"] = r.users[9].user
  obj["name_10"] = r.users[10].user
  obj["name_11"] = r.users[11].user
  obj["name_12"] = r.users[12].user
  obj["name_13"] = r.users[13].user
  obj["name_14"] = r.users[14].user
  obj["Cre"] = "Basil & Tdung"
